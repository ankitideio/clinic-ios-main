...
class AttachmentHandler: NSObject{
    ...
    //MARK: - Constants
    struct Constants {
        static let actionFileTypeHeading = "Add_File"//.localized
        static let actionFileTypeDescription = "Choose_filetype"//.//localized
        static let camera = "Camera"//.localized
        static let phoneLibrary = "Phone_Library"//.localized
